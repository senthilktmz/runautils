...
pub struct Route {
    ...
    pub post_handler: Option<fn(web::Json<String>, &'static str) -> Pin<Box<dyn Future<Output = HttpResponse>>>>,
    pub websocket_handler: Option<fn(actix_web::HttpRequest, actix_web::web::Payload) -> Pin<Box<dyn Future<Output = Result<HttpResponse, actix_web::Error>>>>>,
}
